...
\begin{figure}[!h]
           \begin{floatrow}
             \ffigbox{\includegraphics[width=1.15\linewidth]{billeder/bilmotortids}}{\caption{}\label{case1}}
             \ffigbox{\includegraphics[width=1.15\linewidth]{billeder/storrelsebilmotor}}{\caption{}\label{zoom}}       
...
\begin{figure}[!h]
           \begin{floatrow}
             \ffigbox{\includegraphics[width=1.15\linewidth]{billeder/fasebilmotor}}{\caption{}\label{case1}}
