...
\begin{figure}[!h]
           \begin{floatrow}
             \ffigbox{\includegraphics[width=1.1\linewidth]{billeder/bilmotortids}}{\caption{}\label{case1}}
             \ffigbox{\includegraphics[width=1.1\linewidth]{billeder/storrelsebilmotor}}{\caption{}\label{zoom}}       
           \end{floatrow}
\end{figure}
...
\begin{figure}[!h]
           \begin{floatrow}
             \ffigbox{\includegraphics[width=1.1\linewidth]{billeder/vindtid}}{\caption{}}
             \ffigbox{\includegraphics[width=1.1\linewidth]{billeder/vindstorrelse}}{\caption{}}       
           \end{floatrow}
\end{figure}

\begin{figure}[!h]
           \begin{floatrow}
             \ffigbox{\includegraphics[width=1.1\linewidth]{billeder/vindfase}}{\caption{}}
...
\begin{figure}[!h]
           \begin{floatrow}
             \ffigbox{\includegraphics[width=1.1\linewidth]{billeder/mozarttid}}{\caption{}\label{case1}}
             \ffigbox{\includegraphics[width=1.1\linewidth]{billeder/mozartstorrelse}}{\caption{}\label{zoom}}       
           \end{floatrow}
\end{figure}
...
\begin{figure}[!h]
           \begin{floatrow}
             \ffigbox{\includegraphics[width=1.1\linewidth]{billeder/mozartfase}}{\caption{}}
...
\begin{figure}[!h]
           \begin{floatrow}
             \ffigbox{\includegraphics[width=1.1\linewidth]{billeder/weekndtid}}{\caption{}\label{case1}}
             \ffigbox{\includegraphics[width=1.1\linewidth]{billeder/weekndstorrelse}}{\caption{}\label{zoom}}       
           \end{floatrow}
\end{figure}

\begin{figure}[!h]
           \begin{floatrow}
             \ffigbox{\includegraphics[width=1.1\linewidth]{billeder/weekndfase}}{\caption{}}
...
\begin{figure}[!h]
           \begin{floatrow}
             \ffigbox{\includegraphics[width=1.1\linewidth]{billeder/eminemtid}}{\caption{}\label{case1}}
             \ffigbox{\includegraphics[width=1.1\linewidth]{billeder/eminemstorrelse}}{\caption{}\label{zoom}}       
           \end{floatrow}
\end{figure}

\begin{figure}[!h]
           \begin{floatrow}
             \ffigbox{\includegraphics[width=1.1\linewidth]{billeder/eminemfase}}{\caption{}}
...
\begin{figure}[!h]
           \begin{floatrow}
             \ffigbox{\includegraphics[width=1.1\linewidth]{billeder/arctictid}}{\caption{}\label{case1}}
             \ffigbox{\includegraphics[width=1.1\linewidth]{billeder/arcticstorrelse}}{\caption{}\label{zoom}}       
           \end{floatrow}
\end{figure}
...
\begin{figure}[!h]
           \begin{floatrow}
             \ffigbox{\includegraphics[width=1.1\linewidth]{billeder/arcticfase}}{\caption{}}
...
\begin{figure}[!h]
           \begin{floatrow}
             \ffigbox{\includegraphics[width=1.1\linewidth]{billeder/rednextid}}{\caption{}\label{case1}}
             \ffigbox{\includegraphics[width=1.1\linewidth]{billeder/rednexstorrelse}}{\caption{}\label{zoom}}       
           \end{floatrow}
\end{figure}

\begin{figure}[!h]
           \begin{floatrow}
             \ffigbox{\includegraphics[width=1.1\linewidth]{billeder/rednexfase}}{\caption{}}
